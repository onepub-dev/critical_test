# 5.1.2
- reverted breakage caused by gitbooks update.
- Merge branch 'main' of github.com:bsutton/critical_test
- GitBook: [#9] added notes on settings.yaml and fixed incorrect paths for hooks.
